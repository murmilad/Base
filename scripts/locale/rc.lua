...
tags = {
   ...
   layout = { layouts[3], layouts[1], layouts[3], layouts[1],
...
--  awful.key({ modkey }, "v",                       function () couth.notifier:notify( couth.alsa:getVolume() ) end),
    awful.key({ modkey }, "v",                       function () naughty.notify{
