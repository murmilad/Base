...
menu_gen.all_menu_dirs = { '/usr/share/applications/', '/usr/local/share/applications/',  '/home/alex/.local/share/applications/wine/',  '/home/alex/.local/share/applications/', '/home/alex/.local/share/applications/wine/Programs/' }
...
menu_gen.all_categories = {
    ...
    other = { app_type = "Other", name = "Oher",
                icon_name = "applications-accessories.png", use = true }
}
...
function menu_gen.generate()
    ...
    for _, dir in ipairs(menu_gen.all_menu_dirs) do
        ...
        for _, program in ipairs(entries) do
            ...
            if program.Name and (program.cmdline or program.Exec) then
                local target_category = "other" 
                ...
                if target_category then
                    ...
                    local cmdline = trim(program.cmdline) or  trim(program.Exec) or  ""
                    local icon = utils.lookup_icon(trim(program.icon_path) or trim(program.Icon)) or nil
