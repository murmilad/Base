...
--128x128     ccsm		evolution	 gnome-control-center		 miscellaneous	       ubuntu
--16x16	    cheese		evolution-rss	 gnome-games			 nm		       ubuntu-one
--22x22	    conduit		file-roller	 gnome-media			 notify-osd	       vinagre
--24x24	    dropbox		f-spot		 gnome-packagekit		 rhythmbox	       yelp
--36x36	    empathy		gajim		 gnome-power-manager		 rhythmbox-deprecated
--48x48
...
function utils.lookup_icon(icon_file)
    ...
    if icon_file:sub(1, 1) == '/' and is_format_supported(icon_file) then
        ...
        if icon_theme then
            ...
            table.insert(icon_theme_paths, '/usr/share/icons/' .. icon_theme .. '/gnome/')
...
--        table.insert(icon_theme_paths, '/usr/share/icons/hicolor/') -- fallback theme
        ...
        for i, icon_theme_directory in ipairs(icon_theme_paths) do
            for j, size in ipairs(all_icon_sizes) do
                table.insert(icon_path, icon_theme_directory .. size .. '/Zimages/')
